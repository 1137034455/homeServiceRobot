========================================================================
    ACTIVEX 控件 DLL : SRecoManager 项目概述
========================================================================

控件向导已为 SRecoManager ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 SRecoManager ActiveX 控件 DLL 的每个文件的内容。

SRecoManager.vcxproj
    这是使用应用程序向导生成的 VC++ 项目的主项目文件，
    其中包含生成该文件的 Visual C++ 
    的版本信息，以及有关使用应用程序向导选择的平台、
    配置和项目功能的信息。

SRecoManager.vcxproj.filters
...
/////////////////////////////////////////////////////////////////////////////
CSRecoManagerCtrl 控件：

SRecoManagerCtrl.h
    此文件包含 CSRecoManagerCtrl C++ 类的声明。

SRecoManagerCtrl.cpp
    此文件包含 CSRecoManagerCtrl C++ 类的实现。

SRecoManagerPropPage.h
    此文件包含 CSRecoManagerPropPage C++ 类的声明。

SRecoManagerPropPage.cpp
    此文件包含 CSRecoManagerPropPage C++ 类的实现。

CSRecoManagerCtrl.bmp
    此文件包含一个位图，当 CSRecoManagerCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 SRecoManager.pch 的预编译头 (PCH) 文件和名为 
